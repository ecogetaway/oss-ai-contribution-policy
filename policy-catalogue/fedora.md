...
> **Update, 2026-09-25 (re-verified at source).** The **adopted** policy is published at [docs.fedoraproject.org/en-US/council/policy/ai-contribution-policy](https://docs.fedoraproject.org/en-US/council/policy/ai-contribution-policy/) ("AI-Assisted Contributions Policy", Version 1.0, last review 2025-10-24). This entry was captured from the earlier **proposal** on the Community Blog, and the two differ. **The adopted text does not contain the proposal's sentence encouraging AI translation** ("Using AI tools to translate your thoughts or overcome language barriers is a welcome and encouraged practice"). It says instead (verbatim): "Routine use of assistive tools for correcting grammar and spelling, or for clarifying language, does not require disclosure." Disclosure in the adopted text: "You MUST disclose the use of AI tools when the significant part of the contribution is taken from a tool without changes. You SHOULD disclose the other uses of AI tools, where it might be useful." Recommended mechanism: an `Assisted-by:` commit trailer; other disclosure forms include "translation notes". The governance restriction is retained: AI must not be "the sole or final arbiter" of a substantive judgment, nor "used to evaluate a person's standing within the community (e.g., for funding, leadership roles, or Code of Conduct matters)". **Treat the translation claims below as describing the proposal, not the adopted policy.** A full re-capture is pending.
