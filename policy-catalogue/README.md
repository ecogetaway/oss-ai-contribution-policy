...
**All 21 in one table** (stance, disclosure rule, verification date, sources): [AI contribution policies compared](https://oss-infrastructure-initiative.netlify.app/ai-contribution-policies-compared).
...
| [Rust](rust.md) | adopted 2026-08-05 — ban on creation, experimental tier with disclosure | Now covers six rust-lang repositories (re-verified 2026-09-25); `llm-assisted` label; first quantitative circuit-breaker enforcement rule in the catalogue |
...
| [Mesa](mesa.md) | disclosed-allowed; autonomous agents prohibited; since 2026-09-02 no AI-generated comments or commit messages | Only graduated disclosure vocabulary in the catalogue — `Assisted-by:` vs `Generated-by:` with tool and optional model — while banning `Co-authored-by:` for tools; third project to legislate on commit trailers, and incompatible with both Fedora and Kubernetes |
